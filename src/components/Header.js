...
export const Header = (props) => {
    ...
    //console.log("cart",props.cardData[0])

    // if(props.cardData.length>0){
    //  setcartData(props.cardData)
        ...
        <div>
            ...
            </div>
            {
                cartData.length>0 && cartData.map((cart)=>{
                    ...
                    //console.log("cartmap",cart.cardData.price)
                    console.warn("name = ",cart.cardData.name,"  price =>",cart.cardData.price)
                })
            }
        </div>
    )
