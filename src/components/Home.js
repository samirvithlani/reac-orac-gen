        ...
        <div>
            ...
            <div class="card" style={style}>
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title">PRICE: 225000</h5>
                    <button onClick={()=>{props.addToCartHandler({price:15000,name:"IPHONE13"})}}>ADD TO CART</button>
                    <button onClick={()=>{props.removeToCartHandler({price:15000,name:"IPHONE13"})}}>REMOVE TO CART</button>
                </div>
            </div>
        </div>
